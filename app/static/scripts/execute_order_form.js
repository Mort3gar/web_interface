async function add_execute_order_in_db(){
    ...
    let data = get_data_from_input({"select": {"staff":"executer", "message":"choice_select"}, 
    "field": {"order_id": "order_id", "type_repair":"type_repair", "repair_cost":"repair_cost",
    ...
    if (!check_fields(data)) {
        ...
        await post("/api/add_execution", {"order_id": data["order_id"], "types_of_repairs_id": id_types_of_repair,
            "repair_cost": data["repair_cost"], "order_execution_date": data["date_execute"], "message": Boolean(data["message"]), 
        ...
        await get("/api/get_execution").then(res =>{
            ...
            let data_keys = {"id": current_order["id"], "type_repair": data["type_repair"], "repair_cost": data["repair_cost"], 
            "date_execute": data["date_execute"], "message": Number(data["message"]), "receipt_date": data["receipt_date"], "payment": payment};
